...
public class EmojiRainLayout extends PercentFrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.luolc.emojirain.R.styleable.EmojiRainLayout);

        mSubscriptions = new CompositeSubscription();
        mEmojis = new ArrayList<>();
        mEmojiPer = ta.getInteger(com.luolc.emojirain.R.styleable.EmojiRainLayout_per, DEFAULT_PER);
        mDuration = ta.getInteger(com.luolc.emojirain.R.styleable.EmojiRainLayout_duration, DEFAULT_DURATION);
        mDropAverageDuration = ta.getInteger(com.luolc.emojirain.R.styleable.EmojiRainLayout_dropDuration,
                DEFAULT_DROP_DURATION);
        mDropFrequency = ta.getInteger(com.luolc.emojirain.R.styleable.EmojiRainLayout_dropFrequency,
