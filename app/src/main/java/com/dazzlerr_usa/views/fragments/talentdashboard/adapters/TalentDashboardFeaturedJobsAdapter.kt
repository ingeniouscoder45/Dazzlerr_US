...
class TalentDashboardFeaturedJobsAdapter(val mContext:Context, val mList: MutableList<TalentDashboardPojo.FeaturedJobsBean>): RecyclerView.Adapter<TalentDashboardFeaturedJobsAdapter.MyViewHolder>()
{
    ...
    {
        val bindingObj: DashboardFeaturedjobsItemLayoutBinding
        bindingObj = DataBindingUtil.inflate(LayoutInflater.from(parent.context) , R.layout.dashboard_featuredjobs_item_layout , parent ,false )
    ...
    inner class MyViewHolder(var bindingObj: DashboardFeaturedjobsItemLayoutBinding) : RecyclerView.ViewHolder(bindingObj.root)
