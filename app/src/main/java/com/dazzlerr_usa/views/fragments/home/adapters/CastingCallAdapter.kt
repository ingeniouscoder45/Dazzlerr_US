...
class CastingCallAdapter(internal var context: Context?, internal var mModelList: MutableList<ModelsPojo.DataBean>) : androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == VIEW_TYPE_LOADING)
        {
            ...
            val binderObject = DataBindingUtil.inflate<HomeModelsLayoutBinding>(LayoutInflater.from(parent
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, i: Int) {
        ...
        if(viewHolder is ViewHolder)
        {
            ...
            //  viewHolder.bindingObj.isFeaturedOrTopRated.setImageResource(R.drawable.ic_trending)
