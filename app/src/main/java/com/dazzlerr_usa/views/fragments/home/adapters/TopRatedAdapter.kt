...
class TopRatedAdapter(internal var context: Context?, internal var mModelList: MutableList<ModelsPojo.DataBean>) : androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, i: Int)
    {
        if(viewHolder is ViewHolder) {
            ...
            //viewHolder.bindingObj.isFeaturedOrTopRated.setImageResource(R.drawable.ic_top_rated)
