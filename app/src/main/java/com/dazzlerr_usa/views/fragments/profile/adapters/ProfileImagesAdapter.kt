...
class ProfileImagesAdapter(var context:Context , var mModelList: MutableList<PortfolioImagesPojo.DataBean> , var profile_id: String , var mFragment: ProfileImagesFragment): androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    {
        return if(mModelList.size<9)mModelList.size else 8
    }
