...
import com.dazzlerr_usa.databinding.DashboardAppliedjobsItemLayoutBinding
...
class TalentDashboardAppliedJobsAdapter(val mContext:Context, val mList: MutableList<TalentDashboardPojo.AppliedJobsBean>): RecyclerView.Adapter<TalentDashboardAppliedJobsAdapter.MyViewHolder>()
{
    ...
    {
        val bindingObj: DashboardAppliedjobsItemLayoutBinding
        bindingObj = DataBindingUtil.inflate(LayoutInflater.from(parent.context) , R.layout.dashboard_appliedjobs_item_layout , parent ,false )
    ...
    inner class MyViewHolder(var bindingObj: DashboardAppliedjobsItemLayoutBinding) : RecyclerView.ViewHolder(bindingObj.root)
