...
import com.dazzlerr_usa.databinding.ActivityCastingFollowingsBinding
...
class CastingFollowingsActivity : AppCompatActivity() , CastingFollowingsView , View.OnClickListener {

    @Inject
    lateinit var sharedPreferences: HelperSharedPreferences
    lateinit var bindingObj: ActivityCastingFollowingsBinding

    lateinit var talentsAdapter: TalentsAdapter

    lateinit var talentPresenter: CastingFollowingsPresenter
    val PAGE_START = 1
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindingObj = DataBindingUtil.setContentView(this , R.layout.activity_casting_followings)
        initializations()
        clickListeners()
    ...
    fun initializations()
    {
        ...
        bindingObj.titleLayout.titletxt.text = "Followings"
        talentPresenter = CastingFollowingsModel(this, this)
    }
    ...
    private fun apiCalling(user_id: String , page:String , isShowProgressbar:Boolean)
    {
        ...
        if(isNetworkActive()!!)
        {
            talentPresenter?.getfollowings(user_id , page ,isShowProgressbar)
        }
    ...
    override fun onGetFollowingsSuccess(model: ModelsPojo) {
