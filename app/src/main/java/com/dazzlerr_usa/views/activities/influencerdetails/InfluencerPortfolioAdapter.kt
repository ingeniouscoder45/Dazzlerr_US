...
class InfluencerPortfolioAdapter(var context:Context, var mModelList: MutableList<InfluencerDetailsPojo.PortfolioBean>): androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    fun add(response: InfluencerDetailsPojo.PortfolioBean)
    {
    ...
    fun addAll(Items: MutableList<InfluencerDetailsPojo.PortfolioBean>)
    {
    ...
    fun addLoading()
    {
        ...
        add(InfluencerDetailsPojo.PortfolioBean())
    }
    ...
    fun getItem(position: Int): InfluencerDetailsPojo.PortfolioBean? {
