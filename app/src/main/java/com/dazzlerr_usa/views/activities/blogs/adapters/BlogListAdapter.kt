...
class BlogListAdapter(val mContext:Context, val mList: MutableList<BlogListPojo.ResultBean>, val adapterType: String): RecyclerView.Adapter<BlogListAdapter.MyViewHolder>()
{
    ...
    {
        val bindingObj: BloglistAdapterItemLayoutBinding
        bindingObj = DataBindingUtil.inflate(LayoutInflater.from(parent.context) , R.layout.bloglist_adapter_item_layout , parent ,false )
    ...
    inner class MyViewHolder(var bindingObj: BloglistAdapterItemLayoutBinding) : RecyclerView.ViewHolder(bindingObj.root)
