...
class EventContactActivity : AppCompatActivity(),View.OnClickListener  , EventContactView
{

    @Inject
    lateinit var sharedPreferences: HelperSharedPreferences
    lateinit var mPresenter: EventContactPresenter
    ...
    fun initializations()
    {
        ...
        mPresenter = EventContactModel(this , this)
...
*/
    ...
    private fun apiCalling(name:String ,phone:String,email:String,msg:String,type:String,profile_name:String,user_name:String)
    {
        ...
        if(this@EventContactActivity?.isNetworkActive()!!)
        {
        ...
        else
        {
            ...
            val dialog  = CustomDialog(this@EventContactActivity)
