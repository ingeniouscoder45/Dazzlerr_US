...
class EditTeamAdapter(val mContext:Context, var mModelList: MutableList<GetTeamPojo.DataBean>): androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
