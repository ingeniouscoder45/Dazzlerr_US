...
import com.dazzlerr_usa.databinding.ActivityShortListedTalentsBinding
...
class ShortListedTalentsActivity : AppCompatActivity() , ShortlistedTalentView, View.OnClickListener {


    @Inject
    lateinit var sharedPreferences: HelperSharedPreferences
    lateinit var bindingObj: ActivityShortListedTalentsBinding

    lateinit var talentsAdapter: TalentsAdapter

    lateinit var talentPresenter: ShortlistedTalentPresenter
    val PAGE_START = 1
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        bindingObj = DataBindingUtil.setContentView(this , R.layout.activity_short_listed_talents)
    ...
    fun initializations()
    {
        ...
        bindingObj.titleLayout.titletxt.text = "Shortlisted Talents"
        talentPresenter = ShortlistedTalentModel(this, this)
    }
    ...
    private fun apiCalling(user_id: String , page:String , isShowProgressbar:Boolean)
    {
        ...
        if(isNetworkActive()!!)
        {
            talentPresenter?.getShortlistedTalents(user_id , page ,isShowProgressbar)
        }
