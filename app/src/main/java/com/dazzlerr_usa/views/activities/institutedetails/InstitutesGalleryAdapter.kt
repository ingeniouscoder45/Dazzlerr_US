...
class InstitutesGalleryAdapter(var context:Context, var mModelList: MutableList<InstituteDetailsPojo.Gallery>): androidx.recyclerview.widget.RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    fun add(response: InstituteDetailsPojo.Gallery)
    {
    ...
    fun addAll(Items: MutableList<InstituteDetailsPojo.Gallery>)
    {
    ...
    fun addLoading()
    {
        ...
        add(InstituteDetailsPojo.Gallery())
    }
    ...
    fun getItem(position: Int): InstituteDetailsPojo.Gallery? {
