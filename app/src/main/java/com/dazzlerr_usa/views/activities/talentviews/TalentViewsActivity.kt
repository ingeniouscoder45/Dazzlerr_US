...
import com.dazzlerr_usa.databinding.ActivityTalentViewsBinding
...
class TalentViewsActivity : AppCompatActivity() , TalentViewsView, View.OnClickListener
{

    @Inject
    lateinit var sharedPreferences: HelperSharedPreferences
    lateinit var bindingObj: ActivityTalentViewsBinding
    lateinit var talentPresenter: TalentViewsPresenter
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        bindingObj = DataBindingUtil.setContentView(this ,R.layout.activity_talent_views)
        initializations()
    ...
    fun initializations()
    {
        ...
        bindingObj.titleLayout.titletxt.text = "Views"
        talentPresenter = TalentViewsModel(this, this)
    }
    ...
    {
        talentsAdapter = TalentsAdapter(this@TalentViewsActivity , ArrayList())
        val gManager = GridLayoutManager(this@TalentViewsActivity, 2)
    ...
    private fun apiCalling(user_id: String , page:String , isShowProgressbar:Boolean)
    {
        ...
        if(isNetworkActive()!!)
        {
            talentPresenter?.getViewedTalents(user_id , page ,isShowProgressbar)
        }
    ...
    override fun onGetViewsSuccess(model: ModelsPojo) {
